...
import {
  Palette, Type, Code, Eye, Save, ArrowLeft, Globe, Copy,
} from "lucide-react";
...
export default function CheckoutPage() {
      ...
      <div className="space-y-6 animate-fade-in">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Configure e personalize o checkout das suas ofertas
          </p>
        </div>
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-muted-foreground text-sm">
                Você precisa de pelo menos um produto com uma oferta para configurar o checkout.
              </p>
            </CardContent>
          </Card>
        ) : (
              ...
              {products.map((product) => (
                ...
                >
                  <CardHeader className="pb-2">
                    ...
                    <p className="text-xs text-muted-foreground">{product.description ?? "Sem descrição"}</p>
                  </CardHeader>
  ...
  // Step 2: Checkout editor (Stripe style only)
  return (
    <div className="space-y-6 animate-fade-in">
      {/* Header */}
